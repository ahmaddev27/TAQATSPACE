/* TAQAT — Lucide-style line icons, 1.5px stroke. RTL mirrors directional ones. */
const ICON_PATHS = {
  ...
  megaphone: '<path d="M4 10v4a1 1 0 0 0 1 1h2l9 4V5L7 9H5a1 1 0 0 0-1 1Z"/><path d="M16 8.5a4 4 0 0 1 0 7"/><path d="M7 15v3.5a1.5 1.5 0 0 0 3 0V16"/>',
  inbox: '<path d="M4 13 6 5h12l2 8"/><path d="M4 13v6h16v-6"/><path d="M4 13h5l1.5 2.5h3L15 13h5"/>',
  ...
  building: '<rect x="5" y="3.5" width="14" height="17" rx="1.5"/><path d="M9 7.5h2M13 7.5h2M9 11h2M13 11h2M9 14.5h2M13 14.5h2"/><path d="M10 20.5v-3h4v3"/>',
  shield: '<path d="M12 3 5 6v5.5c0 4 3 7.5 7 9 4-1.5 7-5 7-9V6Z"/><path d="m9 12 2 2 4-4"/>',
  wallet: '<rect x="3.5" y="6" width="17" height="13" rx="2"/><path d="M3.5 9.5h17"/><circle cx="16.5" cy="14" r="1.3"/>',
  ...
  coffee: '<path d="M4 8h13v5a5 5 0 0 1-5 5H9a5 5 0 0 1-5-5Z"/><path d="M17 9h2.5a2.5 2.5 0 0 1 0 5H17"/><path d="M7 3.5v1.5M11 3.5v1.5"/>',
  ...
  parking: '<rect x="4" y="4" width="16" height="16" rx="3"/><path d="M9 17V7h3.5a2.8 2.8 0 0 1 0 5.6H9"/>',
...
function Icon({ name, size = 20, className = '', strokeWidth = 1.5, style }) {
  const dirIcons = ['chevR','chevL','arrowL','arrowR','logout','send'];
  const mirror = dirIcons.includes(name);
  return (
    <svg className={`ico ${mirror ? 'dir-ico' : ''} ${className}`} width={size} height={size}
