...
/**
 * Validates the manual mark-paid action: the payment date is optional (defaults
 * to now in the service), and a payment receipt (pdf/jpg/png, max 5MB) must be
 * attached in the same step — UNLESS the invoice already carries a receipt (e.g.
 * one the member uploaded for review). Authorization is enforced by the route
