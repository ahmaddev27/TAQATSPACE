...
return [
    ...
    */
    ...
    'pos_order_status_updated' => 'تم تحديث حالة الطلب.',
    'pos_order_refunded' => 'تم استرجاع الطلب.',
    'pos_order_not_found' => 'الطلب غير موجود.',
    'pos_order_not_pending' => 'هذا الطلب لم يعد قيد الانتظار.',
    'pos_order_not_payable' => 'لا يمكن دفع هذا الطلب.',
    ...
    'city_deactivated' => 'المدينة مستخدمة، فتم تعطيلها بدلاً من حذفها.',
    ...
    // الإشعارات الفورية — رموز الأجهزة
    'device_token_registered' => 'تم تسجيل الجهاز لاستقبال الإشعارات.',
    'device_token_removed' => 'تم إلغاء تسجيل الجهاز من الإشعارات.',
