...
/**
 * Freelancer realtime chat (Firestore-backed). The freelancer chats with their
 * workspace owner(s). Contacts and the signed-in identity load server-side; the
 * live thread + auth bridge run client-side in {@link ChatScreen}. Contacts may
 * be empty when the chat backend is unconfigured — the screen still degrades to
